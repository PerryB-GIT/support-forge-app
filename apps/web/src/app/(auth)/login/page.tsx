      ...
      <div className="w-full max-w-md">
        ...
        >
          ...
          <button
            ...
            className="w-full py-2.5 px-4 rounded-lg bg-elevated border border-border-subtle hover:border-border-default text-text-primary font-medium transition-colors flex items-center justify-center gap-2"
          >
