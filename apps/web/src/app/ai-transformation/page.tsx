      ...
      <header className="border-b border-border-subtle backdrop-blur-sm bg-background/80 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            <Link href="/ai-transformation" className="text-accent font-medium">AI Transformation</Link>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="font-bold text-accent">SupportForge</span>
            </Link>
            <div className="flex gap-6 text-text-muted">
              <Link href="/ai-transformation" className="hover:text-text-primary transition-colors">AI Transformation</Link>
