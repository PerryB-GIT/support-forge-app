  ...
  return (
    <>
      ...
      <aside className="hidden lg:flex flex-col fixed left-0 top-0 bottom-0 w-64 bg-surface border-r border-border-subtle z-50">
        ...
        {/* Portal Switcher - Only for ADMIN users */}
        {user.role === "ADMIN" && (
          <div className="px-3 pb-2">
            <Link
              href="/admin"
              className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-accent/10 hover:bg-accent/20 text-accent transition-colors border border-accent/20"
            >
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-accent/70">Manage clients & system</p>
              </div>
            </Link>
          </div>
        )}
        ...
        <div className="p-4 border-t border-border-subtle">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-3 py-2 rounded-lg text-text-secondary hover:bg-elevated hover:text-text-primary transition-colors text-sm"
          >
